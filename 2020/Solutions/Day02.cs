...
namespace Solutions
{
    public class Day02
    {
        private void ParsePasswordLine(
            ReadOnlySpan<char> passwordLine,
            out int min,
            out int max,
            out char character,
            out string password)
        {
            ...
            while (passwordLine[end] != '-')
                end += 1;

            min = int.Parse(passwordLine.Slice(start, end));
        ...
        public long Solve1(string[] passwordsLines)
        {
            int min;
            int max;
            char character;
            ...
            for (int i = 0; i < passwordsLines.Length; i++)
            {
                ParsePasswordLine(
                    passwordsLines[i],
                    out min,
        ...
        public long Solve2(string[] passwordsLines)
        {
            int min;
            int max;
            char character;
