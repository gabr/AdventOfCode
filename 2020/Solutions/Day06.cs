...
namespace Solutions
{
    public class Day06
    {
        ...
        public int Solve1(string[] forms)
        {
            var answeredQuestionsSet = new HashSet<char>();
            int sum = 0;
            ...
            foreach (var form in forms)
            {
                if (form == "")
                {
                    sum += answeredQuestionsSet.Count;
        ...
        public int Solve2(string[] forms)
        {
            ...
            foreach (var form in forms)
            {
                if (form == "")
                {
                    sum += answeredQuestions.Count(kv => kv.Value == groupSize);
                ...
                foreach (var question in form)
                {
                    if (answeredQuestions.ContainsKey(question) == false)
                        answeredQuestions.Add(question, 0);
